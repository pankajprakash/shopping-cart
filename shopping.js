...
let categories = document.querySelector(".images");
  let itemData = document.querySelector(".table");

  categories.innerHTML = ` 
  <div class="ourCat">
  <ul>
      <li><a class="menStuf" href="#" id="li1" onclick="men(lil)">men clothing</a> </li>
      <li><a href="#" id="li2"onclick="men(lil2)" >women clothing</a></li>
...
for (let i = 0; i <= data.length-1; i++) {
    ...
    board.innerHTML = `<div class="card" id="all" style="width: 16rem;">
    ...
    <div class="card-body">
     <button id=addtocart onclick="card1()">Add to cart</button>
...
//     case 'lil2':
//     {
//       document.getElementById("lil2").style.display="block";
//       break;
//     }
//     case 'men':
//     {
